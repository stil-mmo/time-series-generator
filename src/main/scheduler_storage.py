...
class SchedulerStorage:
    def __init__(self, num_steps: int, generator_linspace: GeneratorLinspace, points: NDArray[float32], clusters: NDArray[int]):
    ...
    def get_scheduler(self, cluster: int, source_values: NDArray[float] | None = None) -> Scheduler:
